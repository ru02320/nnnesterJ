...
extern unsigned char Save_ini_Settings(class settings_t& settings);
extern unsigned char Load_ini_Settings(class settings_t& settings);
extern unsigned char Load_ini_Dll_Settings(class settings_t& settings);
