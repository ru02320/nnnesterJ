...
#ifndef _win32_directsound_sound_mgr_mono_MONO_
#define _win32_directsound_sound_mgr_mono_MONO_
...
class win32_directsound_sound_mgr_mono : public sound_mgr
{
public:
	win32_directsound_sound_mgr_mono(HWND window_handle, int sample_bits, int sample_rate, int buffer_length_in_frames, int volume);
	~win32_directsound_sound_mgr_mono();
