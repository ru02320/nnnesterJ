...
//	virtual uint8 GetDiskData(uint32 pt)			 {return 0;}
	virtual uint8 *GetDiskDatap()					 {return 0;}
...
protected:
	...
	void set_CPU_bank(uint8 pagen, uint32 kn);
	...
	void set_PPU_bank(uint8, uint32);
