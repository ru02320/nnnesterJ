...
public:
	...
	virtual void setParentNESc() { setParentNES(parent_NES); }
	...
	uint32 get_viewable_height()  { return NES_PPU::getViewableHeight(ScreenMode); }
	...
	uint32 get_viewable_area_y_offset() { return NES_PPU::getTopMargin(ScreenMode); }
