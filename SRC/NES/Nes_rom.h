...
public:
	...
	uint8 get_unifmapper_num() { return unif_mapper; }
	...
	void GetROMInfoStr(char *);
	char *get_GameTitleName(){return GameTitle; }

	uint32 crc32()       { return crc;  }
	uint32 crc32_all()       { return crc_all;  }
	uint32 fds_id()	{ return fds; }

	//  uint32 fds_mk_id()   { return fds0; }
	//  uint32 fds_gm_id()   { return fds1; }

	// for Best Play - Pro Yakyuu Special
	uint32 get_size_SaveRAM() { return size_SaveRAM; }

	uint32 get_UNIF_psize_16k() { return unif_psize_16k;  }
	uint32 get_UNIF_csize_8k() { return unif_csize_8k;  }
