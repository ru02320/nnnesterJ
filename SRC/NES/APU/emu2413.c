...
static void OPLL_CH_reset(EMU2413_OPLL_CH *ch){
...
static EMU2413_OPLL_CH *OPLL_CH_new(){
  ...
  ch = malloc(sizeof(EMU2413_OPLL_CH)) ;
  if(ch == NULL){
    OPLL_SLOT_delete(mod) ;
...
static void OPLL_CH_delete(EMU2413_OPLL_CH *ch){
